...
% This means that 
% an interest group 
% gets the reward of $1$ if the sampled category 
% matches with the category of interest of the interest group,
% and gets the reward of $0$ otherwise.



% $k$th arm $n$ times, sum of rewards $Y_k=\sum_{i=1}^{n} X_k \sim \mathrm{Binomial}(n, \theta_k)$ because the sum of Bernoulli random variables is Binomial.
